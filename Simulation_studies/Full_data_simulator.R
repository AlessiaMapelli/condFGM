...
for(sim_dir in sim_dirs){
  ...
  for(iter_sim_dir in iter_sim_dirs){
    ...
    ggsave(plot,
           filename = paste0(foldname, "/Adjacency_matrix_scores_g1_", name_output, ".png"),
    ...
    ggsave(plot,
           filename = paste0(foldname, "/Adjacency_matrix_node_g1_", name_output, ".png"),
           width = 8, height = 8, dpi = 300)
    ...
    plot <- ggplot(adj_df, aes(x = Col, y = Row, fill = Value)) +
      ...
      labs(title = "Score adjacency Matrix", x = "", y = "")
    ggsave(plot,
           filename = paste0(foldname, "/Adjacency_matrix_scores_g2_", name_output, ".png"),
           width = 8, height = 8, dpi = 300)
    ...
    plot <- ggplot(adj_df, aes(x = Col, y = Row, fill = Value)) +
      ...
      labs(title = "Node adjacency Matrix", x = "", y = "")
    ggsave(plot,
           filename = paste0(foldname, "/Adjacency_matrix_node_g2_", name_output, ".png"),
           width = 8, height = 8, dpi = 300)
