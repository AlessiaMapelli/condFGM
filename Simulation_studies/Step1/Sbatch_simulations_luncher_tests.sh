...
# Systematic simulation launcher
source /center/healthds/singularity_functions

# Change to the working directory
cd Simulation_studies/Step1/

# Configuration
TEMPLATE_CONFIG="Simulation_studies/Step1/config_template.yaml"
YAML_MODIFIER="Simulation_studies/Step1/modify_yaml_config.py"
SAVE_PATH="Simulation_studies/Step1/"
JOBS_LIMIT=100
tot_iteration=10
